...
class saferoute : AppCompatActivity() {
   ...
   lateinit var desti:EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiValueMap["kharadipunestation"] = ArrayList()
        multiValueMap["kharadipunestation"]!!.add("kharadi bypass - chandan nagar - viman nagar - aga khan palace- bund garden - pune station")
        multiValueMap["kharadipunestation"]!!.add("kharadi bypass - mundwa bridge - koraegaon park -dhole patil road - pune station")
